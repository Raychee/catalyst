...
class Job extends EventEmitter {
    ...
    async wait(job, {forSuccess = true} = {}) {
        ...
        job = await new Promise((resolve) => {
            this._waitingForJobs[jobId] = resolve;
            this.emit('waitForJob', jobId);
        });
        delete this._waitingForJobs[jobId];
