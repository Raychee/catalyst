...
const {DEFAULT_JOB_HEARTBEAT, DEFAULT_JOB_HEART_ATTACK, COLLECTION_NAMES} = require('./config');
...
// TODO: rename _locked -> lockedWrite, _full -> full
...
module.exports = class {
    ...
    constructor(options) {
        ...
        this.options.daemon.heartbeat = this.options.daemon.heartbeat || DEFAULT_JOB_HEARTBEAT;
        this.options.daemon.heartAttack = this.options.daemon.heartAttack || DEFAULT_JOB_HEART_ATTACK;
    ...
    async _start({verbose = true} = {}) {
        ...
        const taskLoader = new TaskLoader(this.options.tasks.paths, this.pluginLoader, storeCollection);
