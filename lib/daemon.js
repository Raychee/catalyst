...
// TODO: defaults timeout = -1, dedupWithin = -1
...
module.exports = class extends Runnable {
    ...
    constructor(options) {
        ...
        this.options.tasks.paths = (this.options.tasks.paths || []).map(p => p.replace(/[\\/]/g, sep));
        this.options.plugins = this.options.plugins || {};
        this.options.plugins.paths = (this.options.plugins.paths || []).map(p => p.replace(/[\\/]/g, sep));
